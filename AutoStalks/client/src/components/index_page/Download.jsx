export default function Download() {
  return (
    <>
      <div class="w-full p-4 text-center rounded-lg shadow sm:p-8 bg-black opacity-50 border-gray-700">
        <h5 class="mb-2 text-3xl font-bold text-gray-900 dark:text-white">
          Book your ride from anywhere and anytime
        </h5>
        <p class="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">
          Stay up to date with moto decals and moto details
        </p>
